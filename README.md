# taylor-I705857.github.io[indedx.html.txt](https://github.com/user-attachments/files/28188527/indedx.html.txt)
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>Our PBI website</title>
    <style>
        body { font-family: Arial; max-width: 900px; margin: 0 auto; padding: 20px; }
        iframe, video { width: 100%; max-width: 800px; }
